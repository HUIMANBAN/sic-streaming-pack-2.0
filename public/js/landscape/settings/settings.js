...
function changePage() {
    ...
    switch (id) {
        case '1':
            ...
            hrefInput.value = 'http://' + window.location.host + '/loading';
            break;
        case '2':
            document.querySelector('.iframe[data-id="2"]').classList.add('selected');
            hrefInput.value = 'http://' + window.location.host + '/pause';

            break;
        case '3':
            document.querySelector('.iframe[data-id="3-1"]').classList.add('selected');
            hrefInput.value = 'http://' + window.location.host + '/endNoCam';
            break;
        case '4':
            document.querySelector('.iframe[data-id="4"]').classList.add('selected');
            hrefInput.value = 'http://' + window.location.host + '/watermark';
            break;
